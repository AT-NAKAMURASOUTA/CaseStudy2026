...
public sealed class SamplePlayerController : MonoBehaviour
{
    ...
    {
        // アルファベット生成で A-Z を使うため、ジャンプは Space と上矢印
        if (Keyboard.current != null)
        {
